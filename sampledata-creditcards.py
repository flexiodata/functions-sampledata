...
def get_item_info(item):
    ...
    info = OrderedDict()
    info['cc_provider'] = item.credit_card_provider()
    info['cc_number'] = item.credit_card_number()
    info['cc_expire'] = item.credit_card_expire()
    info['cc_code'] = item.credit_card_security_code()
    return info
