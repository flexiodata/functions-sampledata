# ---
# name: sampledata-creditcards
# deployed: true
# title: Sample Data Credit Cards
# description: Returns a list of sample credit card information
# params:
#   - name: properties
#     type: array
...
def flexio_handler(flex):
    ...
    property_map['cc_provider'] = lambda faker: faker.credit_card_provider()
    property_map['cc_number'] = lambda faker: faker.credit_card_number()
    property_map['cc_expire'] = lambda faker: faker.credit_card_expire()
    property_map['cc_code'] = lambda faker: faker.credit_card_security_code()
