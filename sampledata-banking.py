# ---
# name: sampledata-banking
# deployed: true
# title: Sample Data Banking
# description: Returns a list of sample bank information
# params:
#   - name: properties
#     type: array
...
def flexio_handler(flex):
    ...
    property_map['iban'] = lambda faker: faker.iban()
    property_map['bban'] = lambda faker: faker.bban()
